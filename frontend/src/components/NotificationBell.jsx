...
const TYPE_STYLE = {
  ...
  system:     { color: '#0ea5e9', icon: 'M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM8 4.5a1 1 0 1 1 0 2 1 1 0 0 1 0-2Zm.75 3.25v3.5a.75.75 0 0 1-1.5 0v-3.5a.75.75 0 0 1 1.5 0Z' },
}
